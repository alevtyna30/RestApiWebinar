import dto.request.response.UserNotFoundResponse;
...
public class GetBooksAssignedToUserTest extends BaseTest {
    ...
    public Object[][] dataProvider() {
        return new Object[][]{
                {"TEST0011", 401}, {"TEST0012", 400}, {"Alevtyna_Parysta", 200}
        };
    }

    @Test(description = "Запит даних щодо невалідного ID", dataProvider = "test-data")
    public void TC1(String user, int status) {
        Response response = RestClient.getInstance().sendRequest(HttpMethod.GET, format("Account/v1/User/%s", user), false);
